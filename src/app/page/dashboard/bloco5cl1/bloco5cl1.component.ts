...
import { watersystemBL05CL1 } from '../../../../environments/environment';
import { Router } from '@angular/router';

@Component({
  selector: 'app-bloco5cl1',
  templateUrl: './bloco5cl1.component.html',
  styleUrls: ['./bloco5cl1.component.scss']
})
export class Bloco5cl1Component implements OnInit {

  public volumeValue: number ;

  deviceId = watersystemBL05CL1.deviceId;
