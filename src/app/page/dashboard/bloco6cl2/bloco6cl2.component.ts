...
import { watersystemBL06CL2 } from '../../../../environments/environment';
import { Router } from '@angular/router';

@Component({
  selector: 'app-bloco6cl2',
  templateUrl: './bloco6cl2.component.html',
  styleUrls: ['./bloco6cl2.component.scss']
})
export class Bloco6cl2Component implements OnInit {

  public volumeValue: number ;
  public alertWaterTank = '';
  public cssTankAlert = '';

  deviceId = watersystemBL06CL2.deviceId;
