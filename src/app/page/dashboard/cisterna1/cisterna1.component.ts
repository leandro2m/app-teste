...
import { watersystemCistern01 } from '../../../../environments/environment';
import { Router } from '@angular/router';

@Component({
  selector: 'app-cisterna1',
  templateUrl: './cisterna1.component.html',
  styleUrls: ['./cisterna1.component.scss']
})
export class Cisterna1Component implements OnInit {

  public volumeValue: number ;

  deviceId = watersystemCistern01.deviceId;
