...
import { watersystemBL04CL2 } from '../../../../environments/environment';
import { Router } from '@angular/router';

@Component({
  selector: 'app-bloco4cl2',
  templateUrl: './bloco4cl2.component.html',
  styleUrls: ['./bloco4cl2.component.scss']
})
export class Bloco4cl2Component implements OnInit {

  public volumeValue: number ;
  public alertWaterTank = '';
  public cssTankAlert = '';

  deviceId = watersystemBL04CL2.deviceId;
