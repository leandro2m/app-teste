...
import { watersystemBL03 } from '../../../../environments/environment';
import { Router } from '@angular/router';


@Component({
  selector: 'app-bloco3',
  templateUrl: './bloco3.component.html',
  styleUrls: ['./bloco3.component.scss']
})
export class Bloco3Component implements OnInit {

  public volumeValue: number ;

  deviceId = watersystemBL03.deviceId;
